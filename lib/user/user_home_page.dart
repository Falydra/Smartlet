...
class _UserHomePageState extends State<UserHomePage> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (state == AppLifecycleState.resumed) {
      print('[USER HOME] App resumed, refreshing data...');
    ...
    try {
      ...
      for (int i = 0; i < houses.length; i++) {
        ...
        try {
          ...
          print('RBW ID: $rbwId');
          if (rbwId.isNotEmpty) {
            print('Loading nodes for RBW: $rbwId');
                ...
                try {
                  ...
                  if (nodeIds.isNotEmpty) {
                    try {
                      ...
                      print('[USER HOME] Error fetching node state: $e');
                    }
                  }
  ...
  Future<Map<String, dynamic>> _aggregateLatestReadingsFromQuery(
    ...
    for (final sensor in sensors) {
      ...
      try {
        ...
        print('[USER HOME] Error fetching readings for sensor $sensorId: $e');
      }
    }
  ...
  String? _classifySensorMetric(Map<String,dynamic> s) {
    ...
    if (match(mistSprayKeys)) return 'mist_spray';
    if (match(speakerKeys)) return 'speaker';
